"""Re-evaluate saved LCNN models and write aggregate JSON."""
import json
import os
import pickle
import sys
...
SRC = os.path.join(ROOT, 'results', 'lcnn')
OUT = os.path.join(ROOT, 'results', '_aggregate', 'lcnn.json')
